...
public class CameraHolder {
    ...
    public synchronized android.hardware.Camera open() {
        ...
        if (mCameraDevice == null) {
            ...
            /**
             * 1. 카메라의 기본 아웃풋 포멧은 NV12 입니다.
             * 하지만 프래그먼트 쉐이더에서 YV12 ->RGB로 사용하는 YUV to RGB로 되어있습니다.
             * setPreviewFormat(ImageFormat.YV12);를 사용하던가 다른 쉐이더를 사용해야합니다.
             */
            mCameraDevice.getParameters().setPreviewFormat(ImageFormat.YV12);
            mCameraDevice.getParameters().setPreviewSize(640, 480);
